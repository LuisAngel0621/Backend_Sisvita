...
class Diagnostico(db.Model):
    ...
    usuario_test = db.relationship('UsuarioTest', backref='tb_diagnostico')
    tipo_nivel = db.relationship('Nivel',backref='tb_diagnostico')

    def __init__(self, id_user_test,id_nivel, puntaje, comentario, recomendacion, notificacion):
